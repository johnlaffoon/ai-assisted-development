<#
    Script: link-shared-agents.ps1
    Purpose: Creates a Windows junction point for the entire '.github/agents' folder in a project repository, linking it to the shared repo.
    Usage:
    ...
    - It will create a junction in the target repo at .github/agents, pointing to the shared repo's .github/agents.
    - Ensures .gitignore in the target repo ignores .github/agents.
